                ...
                <table class="table table-bordered table-striped cf">
                  <thead class="cf">
                    <tr>
                      ...
                      <th><i class=" fa fa-user"> </i> Nome do Gestor</th>
                  ...
                  <tbody>
                    <?php $counter1=-1;  if( isset($escola) && ( is_array($escola) || $escola instanceof Traversable ) && sizeof($escola) ) foreach( $escola as $key1 => $value1 ){ $counter1++; ?>
                      <tr>
                        ...
                        <td data-title="Nome do Gestor"><?php echo htmlspecialchars( $value1["nomegestor"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                        <td data-title="Endereço"><?php echo htmlspecialchars( $value1["rua"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["cidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["estado"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                        <td>
                          ...
                          <a class="btn btn-danger btn-xs" onclick="return confirm('Deseja excluir a escola: <?php echo htmlspecialchars( $value1["nomeescola"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')" href="/admin/users/<?php echo htmlspecialchars( $value1["idescola"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"><i class="fa fa-trash-o "></i> Deletar</a>
                        </td>
                      </tr>
                   <?php } ?>
                  </tbody>
