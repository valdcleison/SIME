                  ...
                  <div class="col-md-6 form-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" name="cpfaluno" id="cpf" class="form-control" placeholder="000.000.000-00" ">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <input type="text" name="cpfresponsavel" id="cpf2" class="form-control" placeholder="000.000.000-00"  required>
