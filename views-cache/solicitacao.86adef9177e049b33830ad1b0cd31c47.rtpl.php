                  ...
                  <div class="col-md-6 form-group">
                      ...
                      <div class="col-md-12">
                        <select class="form-control" name="planos">
                          <?php $counter1=-1;  if( isset($planos) && ( is_array($planos) || $planos instanceof Traversable ) && sizeof($planos) ) foreach( $planos as $key1 => $value1 ){ $counter1++; ?>
                            ...
                            <option value="<?php echo htmlspecialchars( $value1["idplano"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php if( $value1["preco"] > 500 ){ ?> {function="utf8_encode($value.descricao)} - R$<?php echo htmlspecialchars( $value1["preco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/Única - R$300,00/mês <?php }else{ ?> <?php echo utf8_encode($value1["descricao"]); ?> - R$<?php echo htmlspecialchars( $value1["preco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/mês <?php } ?> </option>
                          <?php } ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="telefone" id="telefone" class="form-control" minlength="10" maxlength="11">
                      </div>
                      <div class="col-md-6">
                        <span><b>Celular</b></span>  (Apenas números)
                        <input type="text" name="celular" id="celular" class="form-control" minlength="11" maxlength="11" required>
                      </div>
                    </div>
                      <br>
