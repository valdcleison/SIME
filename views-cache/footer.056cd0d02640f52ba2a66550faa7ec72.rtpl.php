<?php if(!class_exists('Rain\Tpl')){exit;}?>    <footer class="site-footer">
  ...
  <script src="/res/Admin/lib/jquery-maskedinput-master/src/jquery.maskedinput.js"></script>
  <script type="text/javascript" src="/res/Layout/js/js.js"></script>
  <script type="text/javascript" src="/res/Layout/js/busca.js"></script>
</body>
