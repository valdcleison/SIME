                      ...
                      <div class="col-lg-12 detailed">
                        ...
                        <h4 class="mb">Contato e endereço</h4>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" name="telefone" placeholder=" " id="phone" class="form-control" value="<?php echo htmlspecialchars( $escola["telefone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" name="celular" placeholder=" " id="cell" class="form-control" value="<?php echo htmlspecialchars( $escola["celular"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" name="email" placeholder=" " id="email" class="form-control" value="<?php echo htmlspecialchars( $escola["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                            </div>
                          </div>
