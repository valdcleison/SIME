      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/portal/aluno/"><i class="fa fa-angle-right"></i>Completo</a></li>
              <!--<li><a href="/portal/aluno/data/"><i class="fa fa-angle-right"></i>Data</a></li>
              <li><a href="/portal/aluno/diario//"><i class="fa fa-angle-right"></i>Diário</a></li>-->
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
