<?php if(!class_exists('Rain\Tpl')){exit;}?>  <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <br><h3><i class="fa fa-angle-right"></i> Cadastro de Usuário</h3></b>
              ...
              <div class=" form">
                ...
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="/portal/users/create/" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="cpf" type="text" name="cpfpessoa"  required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      ...
                      <input class="form-control custom-file-input" id="icavatar" accept=".jpg, .jpeg, .png .gif" type="file" name="avatar"/>
                    </div>
                  </div>
