              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="/admin/planos/create/">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="descricaoplano" minlength="2" type="text"  required />
                    </div>
                  </div>
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      ...
                      <span class="input-group-btn">
                        ...
                        <input class=" form-control" id="preco" name="preco" minlength="2" type="text" required />
                    </div>
