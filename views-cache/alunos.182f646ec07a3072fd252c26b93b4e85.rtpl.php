                ...
                <table class="table table-bordered table-striped cf">
                  <thead class="cf">
                    <tr>
                      ...
                      <th><i class="fa fa-envelope-o"> </i> Numero da matricula</th>
                  ...
                  <tbody>
                    <?php $counter1=-1;  if( isset($alunos) && ( is_array($alunos) || $alunos instanceof Traversable ) && sizeof($alunos) ) foreach( $alunos as $key1 => $value1 ){ $counter1++; ?>
                      ...
                      <tr>
                        ...
                        <td data-title="Numero da matricula" class="hidden-phone"><?php echo htmlspecialchars( $value1["numeromatricula"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
