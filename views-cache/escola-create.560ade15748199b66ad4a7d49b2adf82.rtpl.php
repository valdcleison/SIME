                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <select class="form-control" name="planos">
                          ...
                          <option value="<?php echo htmlspecialchars( $value1["idplano"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["descricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - R$<?php echo htmlspecialchars( $value1["preco"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                          <?php } ?>
