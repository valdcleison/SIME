    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Ausente: <?php echo htmlspecialchars( $ausente, ENT_COMPAT, 'UTF-8', FALSE ); ?>',  <?php echo htmlspecialchars( $ausente, ENT_COMPAT, 'UTF-8', FALSE ); ?>],
          ['Presente: <?php echo htmlspecialchars( $presente, ENT_COMPAT, 'UTF-8', FALSE ); ?>', <?php echo htmlspecialchars( $presente, ENT_COMPAT, 'UTF-8', FALSE ); ?>]
        ]);
